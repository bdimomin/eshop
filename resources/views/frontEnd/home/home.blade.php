                        ...
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        ...
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a href="{{ route('singleproduct') }}" class="link-product-add-cart">Quick View</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Air Tshirt Black</a></h4>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Next Blue Blazer</a></h4>
                                        <div class="info-product-price">
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Maroon Puma Tshirt</a></h4>
                                        <div class="info-product-price">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Multicoloured TShirts</a></h4>
                                        <div class="info-product-price">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Dresses</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$129.99</span>
                                            <del>$150.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Wedding Blazers</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$129.99</span>
                                            <del>$150.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}"> Shirts</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">T shirts</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                        ...
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Wedges</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Sandals</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Casual Shoes</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Sport Shoes</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Watches</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                        ...
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Air Tshirt Black Domyos</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                            ...
                            <div class="col-md-3 product-men yes-marg">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{ route('singleproduct') }}">Hand Bags</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
