    ...
    <ul class="nav" id="side-menu">
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                ...
                <li>
                    <a href="{{ route('categoryManage') }}">Manage Category</a>
                </li>
            </ul>
            <!-- /.nav-second-level -->
        </li>
        <li>
            ...
            <ul class="nav nav-second-level">
                <li>
                    <a href="{{ route('addManufacturer') }}">Add Manufacturer</a>
                </li>
                <li>
                    <a href="{{ route('manageManufacturer') }}">Manage Manufacturer</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                ...
                <li>
                    <a href="{{route('manageProduct')}}">Manage Products</a>
                </li>
            </ul>
        </li>
